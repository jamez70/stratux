...
function DeveloperCtrl($rootScope, $scope, $state, $http, $interval) {
	...
	function connect($scope) {
		...
		socket.onmessage = function (msg) {
            ...
            $scope.TrackIsRecording = status.TrackIsRecording;
            $scope.TrackRecordingStatus = status.TrackRecordingStatus;
			// Errors array.
	...
	$scope.postStartTrack = function () {
		$http.post(URL_STARTNEWTRACK).
		then(function (response) {
			// do nothing
			// $scope.$apply();
		}, function (response) {
	...
	$scope.postStopTrack = function () {
		$http.post(URL_STOPTRACK).
		then(function (response) {
			// do nothing
			// $scope.$apply();
		}, function (response) {
